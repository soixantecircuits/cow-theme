...
function initNav(){
  jQuery("#nav > li > a").not("#nav > li.active > a").bind("mouseenter", function(el){
      ...
      jQuery(".drop").bind("mouseleave",function(el){
      	jQuery("#nav > li.active > div").addClass("drop").removeClass("hide");
      });
  }); 
  jQuery("#nav > li > a").not("#nav > li.active > a").bind("mouseleave", function(el){
      jQuery("#nav > li.active > div").addClass("drop").removeClass("hide");
  }); 
